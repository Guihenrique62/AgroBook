        ...
        <v-navigation-drawer v-model="reactiveVar.drawer" absolute temporary>
            ...
            <v-list nav dense>
                ...
                <v-responsive class="ma-0 mt-6 pa-0" width="500">
                    <v-avatar color="primary" size="150"><div class="text-h4">{{ reactiveVar.nomeAbreviado }}</div></v-avatar>
            ...
            <v-list nav dense v-if="reactiveVar.reseteSenha != 1 && cargoUsuario == 0">
            ...
            <v-list nav dense v-if="reactiveVar.reseteSenha != 1 && cargoUsuario == 1">
