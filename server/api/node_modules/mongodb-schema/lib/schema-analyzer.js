...
function cropStringAt10kCharacters(value) {
...
class SchemaAnalyzer {
    ...
    analyzeDoc(doc) {
        ...
        const addToType = (path, value, schema) => {
            var _a, _b, _c;
            ...
            if (isArrayType(type)) {
                ...
                type.fields = (_c = type.fields) !== null && _c !== void 0 ? _c : {};
                Object.entries(value).forEach(([fieldName, v]) => addToField(fieldName, [...path, fieldName], v, type.fields));
            }
                ...
                type.values.pushSome(type.name === 'String' ? cropStringAt10kCharacters(value) : value);
            }
        };
        const addToField = (fieldName, path, value, schema) => {
            if (!schema[fieldName]) {
                schema[fieldName] = {
                    name: fieldName,
                    path: path,
